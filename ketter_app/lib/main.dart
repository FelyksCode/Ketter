...
import 'package:ketter_app/services/fhir_service.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  final _fhirService = FhirService();
  final _symptomService = SymptomService();

  // Simulated patient reference
  final _patientRef = Reference(reference: 'Patient/1', display: 'Jane Doe');
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  // Create FHIR Condition for Fatigue (as example)
                  final condition = _symptomService.createSymptomResource(
                    symptomName: 'Fatigue',
                    severity: 'mild',
                    subject: _patientRef,
                  );
                  ...
                  // Upload to backend
                  await _fhirService.uploadResource(condition);

                  if (mounted) {
                    Navigator.pop(context);
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Thank you. Your care team has been updated.')),
                    );
                  }
                },
